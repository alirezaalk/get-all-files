...
folder = "/"
output = "checksums_final.md5"
errors = "checksums_final_errors.log"
files_to_ignore = [output, errors, "checksums_fresh.md5", "checksums_fresh_errors.log", "checksums_fresh.py", "checksums_final.py"]
def md5(fname):
